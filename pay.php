        ...
        <table class="table table-responsive table-striped table-sm">
          ...
          foreach($payment as $key)
           echo "<tr>
              ...
              <td class='pt-3'>$key[payement]</td>
              <td class='pt-3'>$key[Billnbr]</td>
              <td class='pt-3'>$key[amountp]</td>
              <td class='pt-3'>$key[balan]</td>
              <td class='pt-3'>$key[Date]</td>
